training: Example Using Multiple Java EE 6 Technologies Deployed as an EAR
==============================================================================================
Author: Pete Muir
Level: Intermediate
Technologies: EAR
...
4. This will deploy `target/training.ear` to the running instance of the server.


Access the application 
---------------------

The application will be running at the following URL: <http://localhost:8080/training-web>.
...
You should see messages similar to the following:
    ...
    INFO  [edu.esprit.pisaas.training.controller.MemberRegistration] (http--127.0.0.1-8080-2) Registering Jane Doe
    INFO  [edu.esprit.pisaas.training.test.MemberRegistrationTest] (http--127.0.0.1-8080-2) Jane Doe was persisted with id 1
    ...
    INFO  [org.jboss.as.connector.subsystems.datasources] (MSC service thread 1-5) JBAS010409: Unbound data source [jboss/datasources/trainingTestDS]
